...
def presentacion():
    ...
    <html>
        ...
        <body>
            ...
            <p> Visita mi perfil en <a href="href="www.linkedin.com/in/gabriela-lezcano-ds"><img alt="LinkedIn" src="https://img.shields.io/badge/LinkedIn-blue?style=flat-square&logo=linkedin"></a></p>
            <p> El desarrollo de este proyecto esta en <a href="https://github.com/GabiL44/PI_MLOpsEngineer"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-black?style=flat-square&logo=github"></a></p>
        </body>
    </html>
    '''
